(function ($) {
    ...
    FlotTooltip.prototype.init = function (plot) {
        ...
        plot.showTooltip = function (target, position, targetPosition) {
            ...
            // convert tooltip content   to real tipText
     ...
     * @param  {string} content -   with tooltip content
	...
	// for CurvedLines plugin we need to read data from different place
        ...
        /* replacement of %ct and other multi-character  s must
           precede the replacement of single-character  s
