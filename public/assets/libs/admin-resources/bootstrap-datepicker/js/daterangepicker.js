...
*/
// Follow the UMD   https://github.com/umdjs/umd/blob/master/ s/returnExportsGlobal.js
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        //html   for the picker UI
        if (typeof options.  !== 'string' && !(options.  instanceof $))
            options.  = '<div class="daterangepicker dropdown-menu">' +
        ...
        this.container = $(options. ).appendTo(this.parentEl);
