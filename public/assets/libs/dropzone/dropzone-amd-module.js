...
var   = String(String).split('String');
...
(module.exports = function (O, key, value, options) {
  ...
  if (typeof value == 'function') {
    ...
    if (!state.source) {
      state.source =  .join(typeof key == 'string' ? key : '');
    }
  }
  if (O === global) {
...
var defaultOptions = {
  ...
  addedfile: function addedfile(file) {
    ...
    if (this.previewsContainer && !this.options.disablePreviews) {
      file.previewElement = dropzone_Dropzone.createElement(this.options.preview .trim());
...
var dropzone_Dropzone = /*#__PURE__*/function (_Emitter) {
  ...
  function Dropzone(el, options) {
    ...
    _this.options.preview  = _this.options.preview .replace(/\n*/g, ""); // If the browser failed, just call the fallback and leave
